...
(function(window, angular, undefined) {
    ...
    .directive('menuLink', [
        ...
        function() {
            return {
                ...
                templateUrl: 'views/ss/menu-empty.tmpl.html'
            };
        }
    ])
    ...
    .run(['$templateCache', function($templateCache) {
        $templateCache.put('views/ss/menu-link.tmpl.html',
            '<md-button\n' +
            '   ss-style-color="{\'background-color\': (isSelected(section.state) || $state.includes(section.state)) ? \'primary.400\': \'primary.700\'}"' +
		...
		$templateCache.put('views/ss/menu-empty.tmpl.html',
            '<md-button\n' +
            '   ss-style-color="{\'background-color\': (isSelected(section.state) || $state.includes(section.state)) ? \'primary.200\': \'primary.600\'}"' +
        ...
        $templateCache.put('views/ss/menu-sidenav.tmpl.html',
			...
			'        <menu-empty section="section" ng-if="section.type === \'empty\'"></menu-empty>' +
